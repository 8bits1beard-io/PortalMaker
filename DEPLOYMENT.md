...
- Creating `.lnk` shortcuts for any app links
...
|-----------|-------------|
| `-Uninstall` | Remove the landing page and shortcuts |
...
| `C:\ProgramData\LandingPage\*.lnk` | App shortcuts |
| `C:\ProgramData\LandingPage\Logs\` | Installation logs |

## Troubleshooting

### Links don't work
- Ensure shortcuts were created in the same folder as the HTML
- Check that file:// protocol is allowed in your browser/kiosk config
- Verify app paths are correct for the target machine
